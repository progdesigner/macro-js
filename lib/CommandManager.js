...
export default class CommandManager {
    ...
    hasCommand( command ) {
        return typeof _commandMap[command] === 'object' ? true : false;
    }
    ...
    register( command, callback ) {
        ...
        _commandMap[command] = commandObject;
    }

    unregister( command ) {
        if (_commandMap[command]) {
            _commandMap[command] = null;
            delete _commandMap[command];
        }
    }
