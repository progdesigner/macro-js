...
class MacroSequence {
    ...
    execute( info = null ) {
        if (this._done === true) {
            console.log( 'this queue is already finished. ignore execute' );
            return;
        }

        if (__DEBUG__) {
            console.log( "MacroSequence - execute : ", this._tag, info );
        }
        ...
        console.log( this._tag, "this._executeCount", this._executeCount );
